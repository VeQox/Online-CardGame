...
<nav class="navbar navbar-light bg-light">
	<div class="container-fluid">
		...
		<form class="d-flex align-items-center">
			<input class="form-control mx-1 text-center" placeholder="Points" disabled bind:value={points}>	
			{#if readyState == -1}
				<input class="formt-control text-center rounded-2 mx-1" placeholder="Name" bind:value={name}>
				<button class="btn btn-outline-success mx-1 d-flex align-items-center w-auto" type="button" on:click={Connect} >	
					{#if readyState == 0 } 
